...
export type InputWithDropdownRef = {
  getValue: () => string;
  clear: () => void;
  focus: () => void;
};
...
const InputWithDropdown = forwardRef<InputWithDropdownRef, Props>(
    (
        {
            value,
            onChange,
                                    ...
                                    filtered.map((item, idx) => {                                        
                                        return (
                                            <li
                                                ...
                                                className={`cursor-pointer px-3 py-2 text-sm ${idx === highlight ? "bg-sky-500 text-white" : "text-gray-700"}`}
                                            >
                                                {item.texto}
